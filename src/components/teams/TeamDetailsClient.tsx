...
export function TeamDetailsClient({ id, signOutButton }: { id: string; signOutButton: ReactNode }) {
    ...
    const { team, members, siteSettings: siteSettingsData, teamStatus, submission, user, collegeName } = data;
                        ...
                        {team.isCompleted && (
                            <div className="space-y-6">
                                ...
                                {teamStatus === "IDEA_SUBMITTED" && submission ? (
                                    ...
                                    <div className="text-[#10569c]">
                                        <TeamSubmissionForm teamId={team.id} onSubmitSuccess={refreshData} />
                                    </div>
                                ) : (
